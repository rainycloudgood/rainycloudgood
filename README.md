...
저는 미래 프론트엔드...? 백엔드...? 뭐 아무렴 어때요? 아무튼 개발자를 꿈꾸고있는 학생이에요! 도전을 좋아하고, 새로운걸 좋아하죠!
학교에 이 정도로 진심인 학생은 없어서 대부분의 활동을 혼자 하고있어요. 하지만 교내 코딩동아리 베리타스의 부장을 맡고있답니다!(히마리 아님)
...
| 프로젝트 | 설명 | 상태 | 스택 |
|---|---|---|---|
| 옥상 (Oksang) | 베리타스의 이름으로 진행한 교내 익명 커뮤니티 앱. 동물 아바타 기반 익명 시스템, 다중 관리자(학교별) 구조 설계 | 잠시 중단 | Flutter, Firebase |
| SubPlan | 국내 서브컬처 행사 정보 정리 플랫폼. 실시간 커뮤니티, 부스 지도, 관리자 패널 구현 | 운영중 | HTML, Firebase(차후 Supabase로 이관계획), 앱 포팅기획중 |
...
| 구분 | 내용 | 일자 |
|---|---|---|
| 🥇 수상 | NYPC 2026 BRONZE | 2026.08.29 |
